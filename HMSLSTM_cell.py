...
class HMSLSTM_cell(rnn_cell_impl.RNNCell):
    ...
    def call(self,input,states):
        ...
        concat=rnn_cell_impl._linear([s_rec,s_td,s_bu],4*self.hstate_size+1,bias=True,bias_initializer=bias_init)  #[B,4d+1]  ,d is the state_size
